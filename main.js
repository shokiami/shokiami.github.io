...
function draw_ripples() {
  for (let ripple of ripples) {
    ...
    for (let i = 0; i < res; i++) {
      ...
      canvas.triangle(x + r * cos1, y + r * sin1, 0, x + r * cos2, y + r * sin2, 0, x + (r - 0.01) * cos1, y + (r - 0.01) * sin1, 0, 1, 1, 1, 1);
      canvas.triangle(x + (r - 0.01) * cos1, y + (r - 0.01) * sin1, 0,  x + r * cos2, y + r * sin2, 0, x + (r - 0.01) * cos2, y + (r - 0.01) * sin2, 0, 1, 1, 1, 1);
    }
  }
}
